...
//   - nb_point_new_pt : number of input new points
//   - ref_points      : set of reference input points.
//   - nb_point_ref_pt : number of input old points
...
float icp(const CvPoint2D32f* new_points,int nb_point_new_pt,
          const CvPoint2D32f* ref_points,int nb_point_ref_pt,
